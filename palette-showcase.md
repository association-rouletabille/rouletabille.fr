...
Each palette below is defined by ten CSS custom properties (exposed in the showcase as `--palette-<token>`). Values are given as the raw `r, g, b` triple used inside `rgb()` and as the equivalent `#RRGGBB` hex code for quick reference. The active palette in [`src/_includes/webc/pagestyle.webc`](src/_includes/webc/pagestyle.webc) carries the same hex codes as inline `/* #RRGGBB */` comments next to each triplet — when switching palettes, update both the RGB values **and** the hex comments.
...
| `--palette-accent-secondary` | 210, 170, 100 | `#D2AA64` |
...
| `--palette-accent-secondary` | 155, 175, 215 | `#9BAFD7` |
...
| `--palette-accent-secondary` | 170, 215, 150 | `#AAD796` |
...
| `--palette-accent-secondary` | 200, 165, 195 | `#C8A5C3` |
...
| `--palette-accent-secondary` | 160, 185, 225 | `#A0B9E1` |
...
| `--palette-accent-secondary` | 195, 140, 100 | `#C38C64` |
...
| `--palette-accent-secondary` | 195, 190, 175 | `#C3BEAF` |
...
| `--palette-accent-secondary` | 150, 200, 190 | `#96C8BE` |
...
| `--palette-accent-secondary` | 185, 160, 210 | `#B9A0D2` |
...
| `--palette-accent-secondary` | 165, 175, 205 | `#A5AFCD` |
...
| `--palette-accent-secondary` | 80, 75, 70    | `#504B46` |
...
| `--palette-accent-secondary` | 55, 70, 110   | `#37466E` |
...
| `--palette-accent-secondary` | 45, 85, 50    | `#2D5532` |
...
| `--palette-accent-secondary` | 80, 50, 30    | `#50321E` |
...
| `--palette-accent-secondary` | 75, 60, 45    | `#4B3C2D` |
...
| `--palette-accent-secondary` | 65, 55, 100   | `#413764` |
...
| `--palette-accent-secondary` | 95, 60, 40    | `#5F3C28` |
...
| `--palette-accent-secondary` | 60, 70, 95    | `#3C465F` |
...
| `--palette-accent-secondary` | 50, 75, 40    | `#324B28` |
...
| `--palette-accent-secondary` | 100, 45, 55   | `#642D37` |
...
| `--palette-accent-secondary` | 140, 170, 220 | `#8CAADC` |
...
| `--palette-accent-secondary` | 150, 175, 110 | `#96AF6E` |
...
| `--palette-accent-secondary` | 200, 175, 110 | `#C8AF6E` |
...
| `--palette-accent-secondary` | 165, 160, 210 | `#A5A0D2` |
...
| `--palette-accent-secondary` | 110, 80, 50   | `#6E5032` |
...
| `--palette-accent-secondary` | 60, 70, 45    | `#3C462D` |
...
| `--palette-accent-secondary` | 45, 70, 95    | `#2D465F` |
...
| `--palette-accent-secondary` | 95, 50, 65    | `#5F3241` |
...
| `--palette-accent-secondary` | 90, 40, 120   | `#5A2878` |
...
| `--palette-accent-secondary` | 100, 220, 225 | `#64DCE1` |
...
| `--palette-accent-secondary` | 255, 80, 180  | `#FF50B4` |
...
| `--palette-accent-secondary` | 230, 130, 180 | `#E682B4` |
...
| `--palette-accent-secondary` | 30, 40, 80    | `#1E2850` |
...
| `--palette-accent-secondary` | 60, 110, 40   | `#3C6E28` |
...
| `--palette-accent-secondary` | 160, 150, 150 | `#A09696` |
...
| `--palette-accent-secondary` | 140, 155, 185 | `#8C9BB9` |
...
| `--palette-accent-secondary` | 185, 100, 70  | `#B96446` |
...
| `--palette-accent-secondary` | 170, 150, 190 | `#AA96BE` |
...
| `--palette-accent-secondary` | 160, 160, 155 | `#A0A09B` |
...
| `--palette-accent-secondary` | 165, 155, 200 | `#A59BC8` |
...
| `--palette-accent-secondary` | 45, 45, 50    | `#2D2D32` |
...
| `--palette-accent-secondary` | 120, 75, 110  | `#784B6E` |
...
| `--palette-accent-secondary` | 130, 180, 170 | `#82B4AA` |
...
| `--palette-accent-secondary` | 80, 75, 65    | `#504B41` |
...
| `--palette-accent-secondary` | 120, 150, 210 | `#7896D2` |
...
| `--palette-accent-secondary` | 75, 95, 140   | `#4B5F8C` |
...
| `--palette-accent-secondary` | 70, 68, 65    | `#464441` |
...
| `--palette-content-fg`       | 35, 25, 20    | `#231914` |
| `--palette-accent`           | 155, 60, 30   | `#9B3C1E` |
| `--palette-accent-secondary` | 100, 80, 60   | `#64503C` |
| `--palette-content-surface`  | 240, 232, 218 | `#F0E8DA` |
...
| `--palette-accent-secondary` | 60, 55, 45    | `#3C372D` |
...
| `--palette-accent-secondary` | 65, 60, 55    | `#413C37` |
...
| `--palette-accent-secondary` | 90, 85, 75    | `#5A554B` |
...
| `--palette-accent-secondary` | 180, 140, 175 | `#B48CAF` |
...
| `--palette-accent-secondary` | 200, 200, 200 | `#C8C8C8` |
...
| `--palette-accent-secondary` | 80, 200, 80   | `#50C850` |
...
| `--palette-accent-secondary` | 35, 35, 30    | `#23231E` |
...
| `--palette-accent-secondary` | 180, 200, 230 | `#B4C8E6` |
...
| `--palette-accent-secondary` | 200, 200, 195 | `#C8C8C3` |
...
| `--palette-accent-secondary` | 60, 160, 80   | `#3CA050` |
...
| `--palette-accent-secondary` | 180, 120, 40  | `#B47828` |
...
| `--palette-accent-secondary` | 140, 105, 30  | `#8C691E` |
...
| `--palette-accent-secondary` | 85, 100, 40   | `#556428` |
...
| `--palette-accent-secondary` | 145, 155, 130 | `#919B82` |
...
| `--palette-accent-secondary` | 80, 90, 110   | `#505A6E` |
...
| `--palette-accent-secondary` | 200, 130, 190 | `#C882BE` |
...
| `--palette-accent-secondary` | 120, 155, 195 | `#789BC3` |
...
| `--palette-accent-secondary` | 40, 45, 80    | `#282D50` |
...
| `--palette-accent-secondary` | 120, 95, 105  | `#785F69` |
...
| `--palette-accent-secondary` | 160, 75, 70   | `#A04B46` |
...
| `--palette-accent-secondary` | 85, 100, 125  | `#55647D` |
...
| `--palette-accent-secondary` | 30, 60, 180   | `#1E3CB4` |
...
| `--palette-accent-secondary` | 230, 190, 30  | `#E6BE1E` |
...
| `--palette-accent-secondary` | 30, 90, 80    | `#1E5A50` |
...
| `--palette-accent-secondary` | 150, 70, 75   | `#96464B` |
...
| `--palette-accent-secondary` | 190, 100, 80  | `#BE6450` |
...
| `--palette-accent-secondary` | 155, 120, 30  | `#9B781E` |
...
| `--palette-accent-secondary` | 80, 180, 160  | `#50B4A0` |
...
| `--palette-accent-secondary` | 80, 55, 30    | `#50371E` |
...
| `--palette-accent-secondary` | 120, 180, 190 | `#78B4BE` |
...
| `--palette-accent-secondary` | 200, 170, 100 | `#C8AA64` |
...
| `--palette-accent-secondary` | 75, 80, 90    | `#4B505A` |
...
| `--palette-accent-secondary` | 70, 55, 45    | `#46372D` |
...
| `--palette-accent-secondary` | 65, 70, 80    | `#414650` |
...
| `--palette-accent-secondary` | 90, 60, 35    | `#5A3C23` |
...
| `--palette-accent-secondary` | 40, 55, 35    | `#283723` |
...
| `--palette-accent-secondary` | 55, 40, 90    | `#37285A` |
...
| `--palette-accent-secondary` | 140, 65, 50   | `#8C4132` |
...
| `--palette-accent-secondary` | 90, 80, 50    | `#5A5032` |
...
| `--palette-accent-secondary` | 85, 70, 55    | `#554637` |
...
| `--palette-accent-secondary` | 95, 70, 45    | `#5F462D` |
...
| `--palette-accent-secondary` | 50, 65, 35    | `#324123` |
| `--palette-content-surface`  | 242, 234, 218 | `#F2EADA` |
...
| `--palette-accent-secondary` | 110, 80, 55   | `#6E5037` |
...
| `--palette-accent-secondary` | 140, 110, 30  | `#8C6E1E` |
...
| `--palette-accent-secondary` | 170, 80, 90   | `#AA505A` |
...
| `--palette-accent-secondary` | 95, 60, 35    | `#5F3C23` |
| `--palette-content-surface`  | 244, 236, 218 | `#F4ECDA` |
...
| `--palette-accent-secondary` | 235, 140, 40  | `#EB8C28` |
...
| `--palette-accent-secondary` | 130, 90, 20   | `#825A14` |
...
| `--palette-accent`           | 30, 90, 155   | `#1E5A9B` |
| `--palette-accent-secondary` | 75, 70, 65    | `#4B4641` |
...
| `--palette-accent-secondary` | 40, 60, 120   | `#283C78` |
...
| `--palette-accent-secondary` | 100, 210, 200 | `#64D2C8` |
...
| `--palette-accent-secondary` | 170, 130, 210 | `#AA82D2` |
...
| `--palette-accent-secondary` | 100, 160, 200 | `#64A0C8` |
...
| `--palette-accent-secondary` | 80, 200, 140  | `#50C88C` |
...
| `--palette-accent-secondary` | 230, 210, 100 | `#E6D264` |
...
| `--palette-accent-secondary` | 50, 70, 120   | `#324678` |
...
| `--palette-accent-secondary` | 130, 65, 95   | `#82415F` |
...
| `--palette-accent-secondary` | 95, 70, 145   | `#5F4691` |
| `--palette-content-surface`  | 234, 230, 221 | `#EAE6DD` |
...
| `--palette-accent-secondary` | 20, 95, 50    | `#145F32` |
| `--palette-content-surface`  | 234, 230, 221 | `#EAE6DD` |
...
| `--palette-accent-secondary` | 50, 50, 48    | `#323230` |
| `--palette-content-surface`  | 226, 218, 204 | `#E2DACC` |
...
| `--palette-accent-secondary` | 180, 200, 140 | `#B4C88C` |
...
| `--palette-accent-secondary` | 60, 140, 220  | `#3C8CDC` |
...
| `--palette-accent-secondary` | 80, 200, 230  | `#50C8E6` |
...
| `--palette-accent-secondary` | 100, 180, 140 | `#64B48C` |
...
| `--palette-accent-secondary` | 230, 80, 60   | `#E6503C` |
...
| `--palette-accent-secondary` | 60, 170, 180  | `#3CAAB4` |
...
| `--palette-accent-secondary` | 200, 110, 170 | `#C86EAA` |
...
| `--palette-accent-secondary` | 80, 150, 220  | `#5096DC` |
...
| `--palette-accent-secondary` | 200, 150, 100 | `#C89664` |
...
| `--palette-accent-secondary` | 60, 60, 60    | `#3C3C3C` |
...
| `--palette-accent-secondary` | 55, 55, 55    | `#373737` |
| `--palette-content-surface`  | 223, 223, 223 | `#DFDFDF` |
...
| `--palette-accent-secondary` | 160, 160, 160 | `#A0A0A0` |
...
| `--palette-accent-secondary` | 200, 180, 0   | `#C8B400` |
...
| `--palette-content-fg`       | 10, 10, 10    | `#0A0A0A` |
| `--palette-accent`           | 236, 0, 140   | `#EC008C` |
| `--palette-accent-secondary` | 0, 140, 200   | `#008CC8` |
| `--palette-content-surface`  | 238, 238, 233 | `#EEEEE9` |
| `--palette-page-bg`          | 242, 89, 178  | `#F259B2` |
| `--palette-bright`           | 255, 255, 255 | `#FFFFFF` |
...
| `--palette-content-fg`       | 10, 10, 10    | `#0A0A0A` |
| `--palette-accent`           | 236, 0, 140   | `#EC008C` |
| `--palette-accent-secondary` | 20, 20, 25    | `#141419` |
| `--palette-content-surface`  | 238, 238, 233 | `#EEEEE9` |
| `--palette-page-bg`          | 242, 89, 178  | `#F259B2` |
| `--palette-bright`           | 255, 255, 255 | `#FFFFFF` |
...
| `--palette-accent-secondary` | 190, 0, 120   | `#BE0078` |
| `--palette-content-surface`  | 238, 238, 233 | `#EEEEE9` |
...
| `--palette-accent-secondary` | 50, 25, 90    | `#32195A` |
...
| `--palette-accent-secondary` | 25, 70, 100   | `#194664` |
...
| `--palette-accent-secondary` | 60, 25, 90    | `#3C195A` |
...
| `--palette-accent-secondary` | 180, 95, 40   | `#B45F28` |
...
| `--palette-accent-secondary` | 108, 113, 196 | `#6C71C4` |
...
| `--palette-accent-secondary` | 42, 161, 152  | `#2AA198` |
...
| `--palette-accent-secondary` | 50, 95, 145   | `#325F91` |
...
| `--palette-accent-secondary` | 200, 120, 50  | `#C87832` |
| `--palette-content-surface`  | 15, 56, 66    | `#0F3842` |
...
| `--palette-accent-secondary` | 180, 100, 100 | `#B46464` |
...
| `--palette-accent-secondary` | 110, 180, 130 | `#6EB482` |
...
| `--palette-accent-secondary` | 120, 140, 200 | `#788CC8` |
...
| `--palette-accent`           | 250, 204, 66  | `#FACC42` |
| `--palette-accent-secondary` | 190, 155, 80  | `#BE9B50` |
...
| `--palette-accent-secondary` | 185, 100, 160 | `#B964A0` |
...
| `--palette-accent-secondary` | 220, 220, 220 | `#DCDCDC` |
| `--palette-content-surface`  | 15, 15, 15    | `#0F0F0F` |
...
| `--palette-accent-secondary` | 255, 200, 85  | `#FFC855` |
| `--palette-content-surface`  | 15, 15, 15    | `#0F0F0F` |
...
| `--palette-accent-secondary` | 108, 134, 239 | `#6C86EF` |
...
| `--palette-accent-secondary` | 0, 55, 120    | `#003778` |
...
| `--palette-accent-secondary` | 148, 80, 220  | `#9450DC` |
| `--palette-content-surface`  | 15, 15, 15    | `#0F0F0F` |
...
| `--palette-accent-secondary` | 240, 210, 80  | `#F0D250` |
...
| `--palette-accent-secondary` | 160, 110, 170 | `#A06EAA` |
...
| `--palette-accent-secondary` | 150, 170, 190 | `#96AABE` |
...
| `--palette-accent-secondary` | 80, 180, 140  | `#50B48C` |
...
| `--palette-accent-secondary` | 120, 70, 40   | `#784628` |
...
| `--palette-accent-secondary` | 80, 190, 210  | `#50BED2` |
...
| `--palette-accent-secondary` | 130, 160, 185 | `#82A0B9` |
...
| `--palette-accent-secondary` | 50, 75, 60    | `#324B3C` |
...
| `--palette-accent-secondary` | 80, 170, 230  | `#50AAE6` |
...
| `--palette-accent-secondary` | 60, 200, 220  | `#3CC8DC` |
...
| `--palette-accent-secondary` | 120, 150, 220 | `#7896DC` |
...
| `--palette-accent-secondary` | 190, 170, 20  | `#BEAA14` |
